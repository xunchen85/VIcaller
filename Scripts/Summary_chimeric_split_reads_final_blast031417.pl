...
############## which kind of read, P, PF/F, or PR/R;
  ...
  if(exists($infor{$line[4]})){
   ...
   if($infor2[4] eq $line[0] && $infor2[5] eq $line[2] && abs($line[$posi]-$infor2[13])<=1 && ($line[3] <= $infor2[$col+1] || $infor2[$col+1] eq 0)){
    $infor2[$col+1]=$line[3];
   ...
   elsif($infor2[4] eq $line[0] && $infor2[5] eq $line[2] && abs($line[$posi]-$infor2[13])>1 && abs($line[$posi]-$infor2[13])<=1000 && ($line[3] <= $infor2[$col+4] || $infor2[$col+4] eq 0)){
    $infor2[$col+4]=$line[3];
   ...
   elsif($infor2[4] eq $line[0] && $infor2[5] eq $line[2] && abs($line[$posi]-$infor2[13])>1000 && ($line[3] <= $infor2[$col+7] || $infor2[$col+7] eq 0)){
    $infor2[$col+7]=$line[3];
   ...
   elsif($infor2[4] eq $line[0] && $infor2[5] ne $line[2] && ($line[3] <= $infor2[$col+10] || $infor2[$col+10] eq 0)){
   ...
   elsif($infor2[4] ne $line[0] && ($line[3] <= $infor2[$col+13] || $infor2[$col+13] eq 0)){
...
######################## human
 ...
 while(<F2>){
  ...
  if(exists($infor{$line[4]})){
   for(my $i=0;$i<@{$infor{$line[4]}};$i++){
    @infor2=@{$infor{$line[4]}[$i]};
   if($infor2[1] eq $line[0] && $infor2[1] eq $line[2] && abs($line[$posi]-$infor2[12])<=1 && ($line[3] <= $infor2[$col+1] || $infor2[$col+1] eq 0)){
    $infor2[$col+1]=$line[3];
    $infor2[$col]=$line[$posi];
    if($infor2[$col+2] eq 0){$infor2[$col+2]=1;}
    elsif($line[3] eq $infor2[$col+1]){$infor2[$col+2]++;}
   ...
   elsif($infor2[1] eq $line[0] && $infor2[1] eq $line[2] && abs($line[$posi]-$infor2[12])>1 && abs($line[$posi]-$infor2[12])<=1000 && ($line[3] <= $infor2[$col+4] || $infor2[$col+4] eq 0)){
    $infor2[$col+4]=$line[3];
    $infor2[$col+3]=$line[$posi];
    if($infor2[$col+5] eq 0){$infor2[$col+5]=1;}
    elsif($line[3] eq $infor2[$col+4]){$infor2[$col+5]++;}
   ...
   elsif($infor2[1] eq $line[0] && $infor2[1] eq $line[2] && abs($line[$posi]-$infor2[12])>1000 && ($line[3] <= $infor2[$col+7] || $infor2[$col+7] eq 0)){
    $infor2[$col+7]=$line[3];
    $infor2[$col+6]=$line[$posi];
    if($infor2[$col+8] eq 0){$infor2[$col+8]=1;}
    elsif($line[3] eq $infor2[$col+7]){$infor2[$col+8]++;}
   ...
   elsif($infor2[1] eq $line[0] && $infor2[1] ne $line[2] && ($line[3] <= $infor2[$col+10] || $infor2[$col+10] eq 0)){
    $infor2[$col+10]=$line[3];
    $infor2[$col+9]=$line[0]."|".$line[2]."|".$line[$posi];
    if($infor2[$col+11] eq 0){$infor2[$col+11]=1;}
    elsif($line[3] eq $infor2[$col+10]){$infor2[$col+11]++;}
   ...
   elsif($infor2[1] ne $line[0] && ($line[3] <= $infor2[$col+13] || $infor2[$col+13] eq 0)){
    $infor2[$col+13]=$line[3];
    $infor2[$col+12]=$line[0]."|".$line[2]."|".$line[$posi];
    if($infor2[$col+14] eq 0){$infor2[$col+14]=1;}
    elsif($line[3] eq $infor2[$col+13]){$infor2[$col+14]++;}
